...
WORKDIR /
COPY ./binutils-2.36.1-bin.tar.bz2 ./gcc-10.2.0-bin.tar.bz2 ./libtool-2.4.6-bin.tar.bz2 ./cmake-3.19.4-Linux-x86_64.tar.gz .
RUN tar xjf gcc-10.2.0-bin.tar.bz2 --strip-components=1 -C / && rm gcc-10.2.0-bin.tar.bz2 && \
    ...
    tar xjf libtool-2.4.6-bin.tar.bz2 --strip-components=1 -C / && rm libtool-2.4.6-bin.tar.bz2 && \    
